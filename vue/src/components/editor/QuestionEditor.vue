<template>
  ...
  <div class="flex items-center justify-between">
    <h3 class="text-lg font-bold">
      {{ index + 1 }}. {{ model.question }} <span v-if="model.mandatory" class="text-red-500">*</span>
    </h3>
  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-3">
      ...
      <select
        ...
        "
      >
        <option v-for="(value, index) in mandatorys" :key="value" :value="value">
          {{ upperCaseFirst(index) }}
        </option>
      </select>
    </div>
...
const mandatorys = computed(() => store.state.mandatorys);
